export default {
  ...
  "home.bullet.c.name": "Aucune limite de taille rebutante",
  "home.bullet.c.description": "Téléchargez des fichiers aussi volumineux que vous le souhaitez. Votre espace disque est la seule limite.",
  ...
  "account.card.info.email": "Adresse courriel",
  ...
  "account.card.password.noPasswordSet": "Vous n'avez pas défini de mot de passe. Pour vous connecter avec votre courriel et mot de passe, vous devez d'abord en définir un.",
  "account.notify.password.success": "Le mot de passe a été modifié avec succès",
  "account.card.oauth.title": "Réseau sociaux",
  ...
  "admin.users.table.email": "Adresse courriel",
  ...
  "admin.users.modal.create.manual-password.description": "S'il n'est pas coché, l'utilisateur recevra un courriel avec un lien pour définir son mot de passe.",
  ...
  "error.msg.default": "Une erreur est survenue.",
  "error.msg.access_denied": "Vous avez annulé le processus d'authentification, veuillez réessayer.",
  "error.msg.expired_token": "Le processus d'authentification prend trop de temps, veuillez réessayer.",
